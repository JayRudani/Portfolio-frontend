        ...
        <Row className="align-items-center">
          ...
          <Col size={12} sm={6} className="text-center text-sm-end">
            <div className="social-icon">
              ...
              <a href="https://drive.google.com/file/d/1WSEbX2h70tbdOAiWdzprqMr52B3f0Tiz/view?usp=sharing" target="_blank"  rel="noopener noreferrer"><img src={resumeIcon} alt="Icon" /></a>
            </div>
